...
class Ship : public MirroredSprite {
 ...
 public:
  ...
  // Optional overrides
  bool isPhysical() { return !blink; }
  bool isVisible() { return visible; }

  // Other accessors
  bool isAlive() { return alive; }
  bool isReady() { return explosion->isFinished(); }
  bool revive() {
    if (isReady()) {
      dx = 0;
      dy = 0;
  ...
  void clearLeft() { left = false; }
  void setRight() { right = true; }
  void clearRight() { right = false; }
  void setAccelerate() { accelerate = true; }
